...
\begin{jobdetails}
\begin{itemize} \itemsep 1pt
    \item Worked on operations execution product, helping grow company from \textbf{7 figures}, via merger and acquisition, \textbf{to 9 figure ARR}
    ...
    \item Guided product, engineering and business with technical optionality and budgetary calculations and optimizations
        \begin{itemize}
            ...
            \item Helped business create financial forecasts for projects, \textbf{increasing project viability} by bringing down the cost \textbf{from \$2.5 million to 350-400k}
            \item Worked with vendors to get them to Do The Right Thing and reduce pressure on internal engineering resources (and helping open source in the process)
        \end{itemize}
\end{itemize}
\vspace{2mm}
...
several data providers for a startup ShopGypsy. Dead.
\vspace{2mm}
...
\begin{jobdetails}
Lead and developed data ingestion engine for real-time crypto stock exchange information. 
Developed data warehouse serving historical data for various cryptocurrency projects.
\vspace{2mm}
...
Developed new product features and worked with vendors to facilitate integrations.
...
\begin{jobdetails}
Developing as open source contributor to Google’s GGRC project, from writing initial specifications
...
\textit{Open Source client for accessing AWS Glacier}
\begin{itemize}
