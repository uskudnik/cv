...
\item Tech led platform team, \textbf{creating embedded analytics platform} that reduced \textbf{time to insight} from \textbf{minutes to seconds}, and \textbf{time to market} from \textbf{weeks to hours}
